...
$(document).ready(function(){
    ...
    _getScript("apps-pengelola");
    _getScript("frame-pengelola-first");
    _getScript("frame-pengelola-login");
    _getScript("frame-pengelola-home");
    _getScript("frame-pengelola-profil");
    _getScript("frame-pengelola-reset-password");
    _getScript("frame-pengelola-add-penjualan");
    _getScript("frame-pengelola-add-pengeluaran");
    _getScript("frame-pengelola-list-penjualan");
    _getScript("frame-pengelola-list-pengeluaran");
    _getScript("frame-pengelola-list-share-profit");
